          ...
          {careerTimeline.map((job, i) => (
            ...
            >
              ...
              <div className="relative flex flex-none flex-col items-center">
                <div
                  className={`relative z-10 h-12 w-12 overflow-hidden rounded-xl border bg-[#0b0f1f] sm:h-14 sm:w-14 transition-opacity duration-200 group-hover/roles:opacity-40 hover:!opacity-100 ${
                    job.current
                ...
                {i < careerTimeline.length - 1 && (
                  <div className="absolute top-12 bottom-[-20px] w-[1px] bg-white/10 sm:top-14">
              ...
              {/* Role card — a "window-chrome" header strip (company + role +
                  ...
                  rounded corners. */}
              <div
                className={`min-w-0 flex-1 overflow-hidden ${CARD} transition-all duration-200 group-hover/roles:opacity-40 hover:!opacity-100 hover:border-[#5ce1e6]/40`}
              >
                {/* Header strip — the "label" zone */}
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-x-4 gap-y-2.5 border-b border-white/10 bg-[#5ce1e6]/[0.06] px-5 py-3.5">
                  ...
                  <span
                    className={`flex-none self-start sm:self-auto whitespace-nowrap rounded-full px-3 py-1 font-source-code-pro text-[11px] font-bold uppercase tracking-[0.12em] ${
                      job.current
