  ...
  >
    ...
    >
      <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:gap-12">
        <div className="group relative grid h-44 w-44 sm:h-56 sm:w-56 flex-none place-items-center overflow-hidden rounded-[32px] border-2 border-[#5ce1e6]/60 bg-[#0b0f1f] shadow-[0_0_16px_rgba(92,225,230,0.35)] transition-transform duration-300 ease-out hover:scale-110 cursor-pointer">
          <img
            src={photo}
            alt="Rishab Negi"
            decoding="async"
