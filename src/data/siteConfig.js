...
export const socialMedia = [
  { id: 'social-media-2', icon: githubWhite, link: 'https://github.com/RISHAB-999' },
  { id: 'social-media-3', icon: linkedin, link: 'https://www.linkedin.com/in/rishabnegi30/' },
];
...
export const pageConfig = {
  ...
  '/resume': { background: pixelCity, showOverlay: false, darken: 0.35, isHome: false },
